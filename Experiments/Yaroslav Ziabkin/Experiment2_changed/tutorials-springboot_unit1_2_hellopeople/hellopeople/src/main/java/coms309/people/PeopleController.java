...
public class PeopleController {
    ...
    /**
     * My controller for updating a job. Updates job for a specific person.
     */
    @PutMapping("/people/{firstName}/job")
    public Person updatePersonJob(@PathVariable String firstName, @RequestBody String newJob) {
